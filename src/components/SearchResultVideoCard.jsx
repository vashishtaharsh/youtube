  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
        ...
        <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-4 overflow-hidden">
          ...
          <div className="hidden md:flex items-center ">
            <div className="flex items-start mr-3">
              <div className="flex h-9 w-9 rounded-full overflow-hidden">
                <img className="h-full w-full object-cover" src={video?.author?.avatar[0]?.url} alt="video" />
              </div>
            </div>
            <div className="flex flex-col">
              ...
              <div className="flex text-sm font-semibold text-white/[0.7] relative top-[1px]">
                <span>
