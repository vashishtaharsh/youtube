...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 flex flex-row items-center justify-between w-full h-14 px-4 md:px-5 bg-black dark:bg-black">
      {loading && <Loader />}
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-5 items-center">
          <img alt='YouTube' className="h-full dark:md:block" src={ytLogo} title="YouTube" />
        </Link>
      </div>
        ...
        <div className="flex items-center">
          <div className="md:flex items-center ">
            ...
            <div className="flex h-10 w-10 overflow-hidden rounded-full md:ml-4">
              <img alt='YouTube' src="https://xsgames.co/randomusers/avatar.php?g=male" />
            </div>
          </div>
        </div>
    </div>
